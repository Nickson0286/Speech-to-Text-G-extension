// this is the file that display on main page. here we will receive data from background.js and display information

console.log("extension loaded automatically");
